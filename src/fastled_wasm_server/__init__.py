...
from typing import AsyncGenerator, Awaitable, Dict, List, Optional, Union
...
class FastLEDWasmAPI:
    ...
    def is_compiler_in_use(self) -> Union[CompilerInUseResponse, Awaitable[CompilerInUseResponse]]:
        """
    ...
    def init_project(self, example: Optional[str] = None) -> Union[bytes, Awaitable[bytes]]:
        """
    ...
    def compile_libfastled(
        ...
        if self.use_async and hasattr(self._client, 'compile_libfastled'):
            ...
            raise NotImplementedError("compile_libfastled is only available for async client")
